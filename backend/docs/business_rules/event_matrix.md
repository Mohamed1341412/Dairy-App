...
- StockService owns all stock projections (current_stock, reserved_stock, available_stock).
- Domain Hooks call StockService methods inside their transactions.
- inventory_hooks only validates and audits movements, never modifies stock directly.
