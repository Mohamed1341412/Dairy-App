...
migrate((app) => {
  ...
  unmarshal({
    "indexes": [
      ...
      "CREATE UNIQUE INDEX `idx_financial_account_ledgers_entry` ON `financial_account_ledgers` (\n  `transaction_id`,\n  `entry_type`\n)",
      "CREATE INDEX `idx_financial_account_ledgers_replay_order` ON `financial_account_ledgers` (`posting_sequence`)"
    ]
  }, collection)
